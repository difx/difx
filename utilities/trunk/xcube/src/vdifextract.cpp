 ...
 * 
 *
 * Copy file from Xcube xf1 filesystem
 *
 */
#include <stdio.h>
#include <stdlib.h>
...
int readLF1file(string project, string stream, string outname) {
  char *fileNames[16];
  int nFile = 0;
  FILE *out;
...
int main(int argc, char **argv) {
  ...
  return readLF1file(argv[1],argv[2], outname);
