...
c      print 9173, CFBASE(1), CFBASE(2), CFBASE(3)
c 9173 format( ' CFBASE:: ', 3F20.6 )
...
c      print 9175, XJD, CT
c 9175 format( ' XJD= ', E20.10, '  CT= ', E20.10 )

      CALL PEP (XJD, CT, TSKIP, EARTH, SUN, XMOON)

c      do jj = 1,3
c         print 9174, jj, EARTH(jj,1), EARTH(jj,2), EARTH(jj,3)
c 9174    format( ' EARTH(', I1, ', )::', 3E18.8 )
c      end do
