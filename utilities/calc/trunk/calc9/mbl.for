...
c      common / wew / wewut1
	...
	real*8	uvw(3), duvw(3)
	real*8	uvwa(3), duvwa(3)
	real*8	uvwb(3), duvwb(3)
...
c      print *, ' BEGIN LOOP '
	...
	write(9, 887) src16, c8sit(1), c8sit(2)
        write(10, 887) src16, c8sit(1), c8sit(2)
...
987	format( A, 5I4, 2X, F13.6 )
	...
	1		delay(k), drate(k), uvw, duvw )
        ...
        write (10,985) utcsec, uvwa(1), uvwa(2), uvwa(3), uvwb(1), 
     .               uvwb(2), uvwb(3)
985     format ( F14.6, 3E20.10, 3E20.10)
