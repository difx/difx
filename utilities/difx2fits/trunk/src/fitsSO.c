	...
	struct fits_keywords *p_fits_keys, struct fitsPrivate *out)
{
	...
	{
		{"ID_NO.", "1J", "source id number"},
		{"SOURCE", "16A", "source name"},
		{"QUAL", "1J", "source qualifier"},
		{"CALCODE", "4A", "calibrator code"},
		{"FREQID", "1J", "freq id number in frequency tbl"},
		...
		{"ALPHA", bandFormFloat, "spectral index"},
		{"FREQOFF", bandFormDouble, "freq. offset from ref freq.", 
			"HZ"},
		...
		{"SYSVEL", bandFormDouble, "systemic velocity at ref pixal", 
			"M/SEC"},
		{"VELTYP", "8A", "velocity type"},
		{"VELDEF", "8A", "velocity def: radio, optical"},
