...
AntennaDBEntry antennaDBEntries[] =	/* FIXME: add individual antennas of arrays? */
{
	...
	{ "VLA-Y27",        "VLA-Y27",  -1601185.4286,  -5041977.1754,   3554875.6231,  0.0 },
	{ "VLA-W1",         "VLA-W1",   -1601189.0571,  -5042000.1631,   3554843.1461,  25.0 },		/* Sched catalog */
	{ "VLA-W2",         "VLA-W2",   -1601225.3052,  -5041980.0412,   3554855.4131,  25.0 },		/* Sched catalog */
	{ "VLA-W3",         "VLA-W3",   -1601265.1742,  -5041982.2374,   3554834.5855,  25.0 },		/* Sched catalog */
	{ "VLA-W4",         "VLA-W4",   -1601315.9227,  -5041984.9942,   3554808.0289,  25.0 },		/* Sched catalog */
	{ "VLA-W5",         "VLA-W5",   -1601377.0404,  -5041988.3479,   3554776.1224,  25.0 },		/* Sched catalog */
	{ "VLA-W6",         "VLA-W6",   -1601447.2375,  -5041992.1619,   3554739.4257,  25.0 },		/* Sched catalog */
	{ "VLA-W7",         "VLA-W7",   -1601526.3929,  -5041996.5215,   3554698.0465,  25.0 },		/* Sched catalog */
	{ "VLA-W8",         "VLA-W8",   -1601614.1208,  -5042001.3283,   3554652.2340,  25.0 },		/* Sched catalog */
	{ "VLA-W9",         "VLA-W9",   -1601710.0500,  -5042006.5989,   3554602.0752,  25.0 },		/* Sched catalog */
	{ "VLA-W10",        "VLA-W10",  -1601814.0835,  -5042012.5727,   3554547.9456,  25.0 },		/* Sched catalog */
	{ "VLA-W12",        "VLA-W12",  -1602044.9320,  -5042025.4990,   3554427.5600,  25.0 },		/* Sched catalog */
	{ "VLA-W14",        "VLA-W14",  -1602304.9527,  -5042039.5129,   3554291.4579,  25.0 },		/* Sched catalog */
	{ "VLA-W16",        "VLA-W16",  -1602592.8832,  -5042054.6787,   3554140.4270,  25.0 },		/* Sched catalog */
	{ "VLA-W18",        "VLA-W18",  -1602908.2172,  -5042071.9756,   3553975.6326,  25.0 },		/* Sched catalog */
	{ "VLA-W20",        "VLA-W20",  -1603249.7135,  -5042091.0794,   3553797.5266,  25.0 },		/* Sched catalog */
	{ "VLA-W24",        "VLA-W24",  -1604008.7704,  -5042135.5030,   3553403.4299,  25.0 },		/* Sched catalog */
	{ "VLA-W28",        "VLA-W28",  -1604865.6787,  -5042189.7242,   3552962.0919,  25.0 },		/* Sched catalog */
	{ "VLA-W32",        "VLA-W32",  -1605808.6867,  -5042229.7669,   3552458.9295,  25.0 },		/* Sched catalog */
	{ "VLA-W36",        "VLA-W36",  -1606841.9927,  -5042279.3743,   3551912.7474,  25.0 },		/* Sched catalog */
	{ "VLA-W40",        "VLA-W40",  -1607962.4855,  -5042337.8879,   3551324.6722,  25.0 },		/* Sched catalog */
	{ "VLA-W48",        "VLA-W48",  -1610451.9580,  -5042470.8110,   3550020.7849,  25.0 },		/* Sched catalog */
	{ "VLA-W56",        "VLA-W56",  -1613255.4369,  -5042612.7694,   3548545.6335,  25.0 },		/* Sched catalog */
	{ "VLA-W64",        "VLA-W64",  -1616361.6129,  -5042770.2026,   3546911.1679,  25.0 },		/* Sched catalog */
	{ "VLA-W72",        "VLA-W72",  -1619757.3374,  -5042937.3531,   3545120.1144,  25.0 },		/* Sched catalog */
	{ "VLA-E1",         "VLA-E1",   -1601192.4968,  -5042022.5297,   3554810.1679,  25.0 },		/* Sched catalog */
	{ "VLA-E2",         "VLA-E2",   -1601150.0980,  -5042000.3007,   3554860.4546,  25.0 },		/* Sched catalog */
	{ "VLA-E3",         "VLA-E3",   -1601114.3827,  -5042022.8180,   3554844.6724,  25.0 },		/* Sched catalog */
	{ "VLA-E4",         "VLA-E4",   -1601068.8167,  -5042051.5957,   3554824.5596,  25.0 },		/* Sched catalog */
	{ "VLA-E5",         "VLA-E5",   -1601014.4786,  -5042085.9133,   3554800.5128,  25.0 },		/* Sched catalog */
	{ "VLA-E6",         "VLA-E6",   -1600951.6055,  -5042125.5814,   3554772.7320,  25.0 },		/* Sched catalog */
	{ "VLA-E7",         "VLA-E7",   -1600880.6058,  -5042170.0628,   3554741.1812,  25.0 },		/* Sched catalog */
	{ "VLA-E8",         "VLA-E8",   -1600801.9546,  -5042219.0419,   3554706.1713,  25.0 },		/* Sched catalog */
	{ "VLA-E9",         "VLA-E9",   -1600715.9812,  -5042272.8644,   3554667.9081,  25.0 },		/* Sched catalog */
	{ "VLA-E10",        "VLA-E10",  -1600622.9576,  -5042331.4406,   3554626.7633,  25.0 },		/* Sched catalog */
	{ "VLA-E12",        "VLA-E12",  -1600416.5386,  -5042462.1256,   3554535.7642,  25.0 },		/* Sched catalog */
	{ "VLA-E14",        "VLA-E14",  -1600183.9859,  -5042609.6600,   3554433.3509,  25.0 },		/* Sched catalog */
	{ "VLA-E18",        "VLA-E18",  -1599644.8917,  -5042953.3427,   3554196.7583,  25.0 },		/* Sched catalog */
	{ "VLA-E20",        "VLA-E20",  -1599340.8285,  -5043150.6404,   3554064.9425,  25.0 },		/* Sched catalog */
	{ "VLA-E24",        "VLA-E24",  -1598663.1181,  -5043581.0671,   3553766.7519,  25.0 },		/* Sched catalog */
	{ "VLA-E28",        "VLA-E28",  -1597899.9316,  -5044068.3514,   3553432.1680,  25.0 },		/* Sched catalog */
	{ "VLA-E32",        "VLA-E32",  -1597053.1443,  -5044604.3620,   3553058.7104,  25.0 },		/* Sched catalog */
	{ "VLA-E36",        "VLA-E36",  -1596127.7581,  -5045193.4187,   3552652.1423,  25.0 },		/* Sched catalog */
	{ "VLA-E40",        "VLA-E40",  -1595124.9507,  -5045829.1329,   3552210.4083,  25.0 },		/* Sched catalog */
	{ "VLA-E48",        "VLA-E48",  -1592894.1024,  -5047228.8004,   3551220.9262,  25.0 },		/* Sched catalog */
	{ "VLA-E56",        "VLA-E56",  -1590380.6222,  -5048809.9236,   3550108.1836,  25.0 },		/* Sched catalog */
	{ "VLA-E64",        "VLA-E64",  -1587600.2240,  -5050575.5422,   3548885.1217,  25.0 },		/* Sched catalog */
	{ "VLA-E72",        "VLA-E72",  -1584460.9138,  -5052385.2827,   3547599.7357,  25.0 },		/* Sched catalog */
	{ "VLA-N1",         "VLA-N1",   -1601185.6548,  -5041977.8350,   3554876.1507,  25.0 },		/* Sched catalog */
	{ "VLA-N2",         "VLA-N2",   -1601180.9010,  -5041947.1178,   3554921.3474,  25.0 },		/* Sched catalog */
	{ "VLA-N3",         "VLA-N3",   -1601177.4113,  -5041924.7316,   3554954.3022,  25.0 },		/* Sched catalog */
	{ "VLA-N4",         "VLA-N4",   -1601174.0201,  -5041902.3254,   3554987.2493,  25.0 },		/* Sched catalog */
	{ "VLA-N5",         "VLA-N5",   -1601168.8039,  -5041868.7306,   3555036.6639,  25.0 },		/* Sched catalog */
	{ "VLA-N6",         "VLA-N6",   -1601162.6313,  -5041828.6653,   3555095.6184,  25.0 },		/* Sched catalog */
	{ "VLA-N7",         "VLA-N7",   -1601155.6643,  -5041783.5105,   3555162.1058,  25.0 },		/* Sched catalog */
	{ "VLA-N8",         "VLA-N8",   -1601147.726,   -5041733.509,    3555235.766,   25.0 },		/* ITRF2014 */
	{ "VLA-N9",         "VLA-N9",   -1601139.5107,  -5041678.7232,   3555316.2743,  25.0 },		/* Sched catalog */
	{ "VLA-N10",        "VLA-N10",  -1601130.3625,  -5041619.4477,   3555403.4595,  25.0 },		/* Sched catalog */
	{ "VLA-N12",        "VLA-N12",  -1601110.0805,  -5041487.7546,   3555597.1623,  25.0 },		/* Sched catalog */
	{ "VLA-N14",        "VLA-N14",  -1601087.1959,  -5041339.5354,   3555815.5928,  25.0 },		/* Sched catalog */
	{ "VLA-N16",        "VLA-N16",  -1601061.9856,  -5041175.5631,   3556057.7527,  25.0 },		/* Sched catalog */
	{ "VLA-N18",        "VLA-N18",  -1601034.4283,  -5040996.2193,   3556322.6594,  25.0 },		/* Sched catalog */
	{ "VLA-N20",        "VLA-N20",  -1601004.7375,  -5040802.4843,   3556609.8561,  25.0 },		/* Sched catalog */
	{ "VLA-N24",        "VLA-N24",  -1600930.1133,  -5040316.0759,   3557330.1081,  25.0 },		/* Sched catalog */
	{ "VLA-N28",        "VLA-N28",  -1600863.7131,  -5039884.9934,   3557965.0425,  25.0 },		/* Sched catalog */
	{ "VLA-N32",        "VLA-N32",  -1600781.0678,  -5039347.1309,   3558761.2651,  25.0 },		/* Sched catalog */
	{ "VLA-N36",        "VLA-N36",  -1600690.6346,  -5038758.4093,   3559631.7846,  25.0 },		/* Sched catalog */
	{ "VLA-N40",        "VLA-N40",  -1600592.7766,  -5038121.0264,   3560574.5734,  25.0 },		/* Sched catalog */
	{ "VLA-N48",        "VLA-N48",  -1600374.9276,  -5036703.8734,   3562667.6156,  25.0 },		/* Sched catalog */
	{ "VLA-N56",        "VLA-N56",  -1600128.4269,  -5035103.8229,   3565024.3932,  25.0 },		/* Sched catalog */
	{ "VLA-N64",        "VLA-N64",  -1599855.6997,  -5033332.0554,   3567636.3526,  25.0 },		/* Sched catalog */
	{ "VLA-N72",        "VLA-N72",  -1599557.9635,  -5031396.0524,   3570494.4837,  25.0 },		/* Sched catalog */
