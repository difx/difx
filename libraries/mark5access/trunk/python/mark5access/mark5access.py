# automatically generated by python-ctypeslib for mark5_stream.h version 1.5.3
from ctypes import *

_libraries = {}
_libraries['../mark5access/.libs/libmark5access.so'] = CDLL('../mark5access/.libs/libmark5access.so')
STRING = c_char_p
...
delete_mark5_stream_generic = _libraries['../mark5access/.libs/libmark5access.so'].delete_mark5_stream_generic
delete_mark5_stream_generic.restype = None
delete_mark5_stream_generic.argtypes = [POINTER(mark5_stream_generic)]
delete_mark5_format_generic = _libraries['../mark5access/.libs/libmark5access.so'].delete_mark5_format_generic
delete_mark5_format_generic.restype = None
delete_mark5_format_generic.argtypes = [POINTER(mark5_format_generic)]
mark5_format_generic_print = _libraries['../mark5access/.libs/libmark5access.so'].mark5_format_generic_print
mark5_format_generic_print.restype = None
mark5_format_generic_print.argtypes = [POINTER(mark5_format_generic)]
new_mark5_stream = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_stream
...
new_mark5_stream_absorb = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_stream_absorb
...
delete_mark5_stream = _libraries['../mark5access/.libs/libmark5access.so'].delete_mark5_stream
delete_mark5_stream.restype = None
delete_mark5_stream.argtypes = [POINTER(mark5_stream)]
mark5_stream_resync = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_resync
mark5_stream_resync.restype = c_int
mark5_stream_resync.argtypes = [POINTER(mark5_stream)]
mark5_stream_print = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_print
mark5_stream_print.restype = c_int
mark5_stream_print.argtypes = [POINTER(mark5_stream)]
mark5_stream_get_frame_time = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_get_frame_time
...
mark5_stream_get_sample_time = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_get_sample_time
...
mark5_stream_fix_mjd = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_fix_mjd
mark5_stream_fix_mjd.restype = c_int
mark5_stream_fix_mjd.argtypes = [POINTER(mark5_stream), c_int]
mark5_stream_seek = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_seek
mark5_stream_seek.restype = c_int
mark5_stream_seek.argtypes = [POINTER(mark5_stream), c_int, c_int, c_double]
mark5_stream_copy = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_copy
mark5_stream_copy.restype = c_int
mark5_stream_copy.argtypes = [POINTER(mark5_stream), c_int, STRING]
mark5_stream_set_blanker = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_set_blanker
mark5_stream_set_blanker.restype = c_int
mark5_stream_set_blanker.argtypes = [POINTER(mark5_stream), Mark5Blanker]
mark5_stream_decode = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_decode
mark5_stream_decode.restype = c_int
mark5_stream_decode.argtypes = [POINTER(mark5_stream), c_int, POINTER(POINTER(c_float))]
mark5_stream_decode_double = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_decode_double
...
mark5_stream_count_high_states = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_count_high_states
...
new_mark5_stream_memory = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_stream_memory
new_mark5_stream_memory.restype = POINTER(mark5_stream_generic)
new_mark5_stream_memory.argtypes = [c_void_p, c_uint]
new_mark5_stream_file = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_stream_file
new_mark5_stream_file.restype = POINTER(mark5_stream_generic)
new_mark5_stream_file.argtypes = [STRING, c_longlong]
mark5_stream_file_add_infile = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_file_add_infile
mark5_stream_file_add_infile.restype = c_int
mark5_stream_file_add_infile.argtypes = [POINTER(mark5_stream), STRING]
new_mark5_stream_unpacker = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_stream_unpacker
new_mark5_stream_unpacker.restype = POINTER(mark5_stream_generic)
new_mark5_stream_unpacker.argtypes = [c_int]
mark5_unpack = _libraries['../mark5access/.libs/libmark5access.so'].mark5_unpack
mark5_unpack.restype = c_int
mark5_unpack.argtypes = [POINTER(mark5_stream), c_void_p, POINTER(POINTER(c_float)), c_int]
mark5_unpack_with_offset = _libraries['../mark5access/.libs/libmark5access.so'].mark5_unpack_with_offset
...
new_mark5_format_vlba = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_format_vlba
new_mark5_format_vlba.restype = POINTER(mark5_format_generic)
new_mark5_format_vlba.argtypes = [c_int, c_int, c_int, c_int, c_int]
new_mark5_format_vlba_nomod = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_format_vlba_nomod
...
new_mark5_format_mark4 = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_format_mark4
new_mark5_format_mark4.restype = POINTER(mark5_format_generic)
new_mark5_format_mark4.argtypes = [c_int, c_int, c_int, c_int, c_int]
new_mark5_format_mark5b = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_format_mark5b
new_mark5_format_mark5b.restype = POINTER(mark5_format_generic)
new_mark5_format_mark5b.argtypes = [c_int, c_int, c_int, c_int]
mark5_format_vdif_set_leapsecs = _libraries['../mark5access/.libs/libmark5access.so'].mark5_format_vdif_set_leapsecs
mark5_format_vdif_set_leapsecs.restype = None
mark5_format_vdif_set_leapsecs.argtypes = [POINTER(mark5_stream), c_int]
mark5_format_vdifb_set_leapsecs = _libraries['../mark5access/.libs/libmark5access.so'].mark5_format_vdifb_set_leapsecs
mark5_format_vdifb_set_leapsecs.restype = None
mark5_format_vdifb_set_leapsecs.argtypes = [POINTER(mark5_stream), c_int]
new_mark5_format_kvn5b = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_format_kvn5b
new_mark5_format_kvn5b.restype = POINTER(mark5_format_generic)
new_mark5_format_kvn5b.argtypes = [c_int, c_int, c_int, c_int]
new_mark5_format_d2k = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_format_d2k
new_mark5_format_d2k.restype = POINTER(mark5_format_generic)
new_mark5_format_d2k.argtypes = [c_int, c_int, c_int, c_int]
new_mark5_format_generic_from_string = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_format_generic_from_string
...
blanker_mark5 = _libraries['../mark5access/.libs/libmark5access.so'].blanker_mark5
...
mark5_stream_list_formats = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_list_formats
mark5_stream_list_formats.restype = STRING
mark5_stream_list_formats.argtypes = []
new_mark5_format_from_name = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_format_from_name
new_mark5_format_from_name.restype = POINTER(mark5_format)
new_mark5_format_from_name.argtypes = [STRING]
new_mark5_format_from_stream = _libraries['../mark5access/.libs/libmark5access.so'].new_mark5_format_from_stream
...
delete_mark5_format = _libraries['../mark5access/.libs/libmark5access.so'].delete_mark5_format
delete_mark5_format.restype = None
delete_mark5_format.argtypes = [POINTER(mark5_format)]
print_mark5_format = _libraries['../mark5access/.libs/libmark5access.so'].print_mark5_format
print_mark5_format.restype = None
print_mark5_format.argtypes = [POINTER(mark5_format)]
mark5_library_init = _libraries['../mark5access/.libs/libmark5access.so'].mark5_library_init
mark5_library_init.restype = None
mark5_library_init.argtypes = []
mark5_library_getoption = _libraries['../mark5access/.libs/libmark5access.so'].mark5_library_getoption
mark5_library_getoption.restype = c_int
mark5_library_getoption.argtypes = [c_int, c_void_p]
mark5_library_setoption = _libraries['../mark5access/.libs/libmark5access.so'].mark5_library_setoption
mark5_library_setoption.restype = c_int
mark5_library_setoption.argtypes = [c_int, c_void_p]
mark5_stream_next_frame = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_next_frame
mark5_stream_next_frame.restype = c_int
mark5_stream_next_frame.argtypes = [POINTER(mark5_stream)]
mark5_stream_open = _libraries['../mark5access/.libs/libmark5access.so'].mark5_stream_open
...
__all__ = ['mark5_stream_next_frame', 'new_mark5_format_mark4',
           ...
           'new_mark5_stream_unpacker', 'mark5_stream',
           'mark5_format', 'mark5_library_getoption',
           'mark5_library_init', 'mark5_unpack_with_offset',
           'mark5_format_vdif_set_leapsecs',
           ...
           'mark5_stream_fix_mjd', 'new_mark5_format_mark5b',
           'mark5_format_generic_print', 'new_mark5_format_from_name',
           'mark5_format_vdifb_set_leapsecs', 'MK5_FORMAT_UNKNOWN',
           'new_mark5_format_from_stream',
           'mark5_stream_decode_double', 'MK5_BLANKER_VDIF',
           'print_mark5_format', 'mark5_stream_seek',
           'mark5_stream_file_add_infile', 'new_mark5_stream_absorb',
           'new_mark5_stream_file', 'mark5_stream_print',
           'MK5_FORMAT_VDIFL', 'mark5_stream_list_formats',
           'delete_mark5_stream_generic', 'MK5_FORMAT_D2K',
           'delete_mark5_stream', 'new_mark5_stream',
           'MK5_FORMAT_VDIFB', 'MK5_FORMAT_VDIF', 'MK5_FORMAT_K5',
           'mark5_stream_generic', 'mark5_library_setoption',
           'new_mark5_format_generic_from_string',
           'MK5_BLANKER_MARK5', 'mark5_stream_copy', 'Mark5Format',
           'mark5_stream_decode', 'MK5_FORMAT_VLBN',
           'mark5_stream_resync', 'MK5_FORMAT_MARK5B',
           'mark5_stream_set_blanker', 'new_mark5_format_kvn5b',
           'MK5_FORMAT_VLBA', 'mark5_stream_get_frame_time']
