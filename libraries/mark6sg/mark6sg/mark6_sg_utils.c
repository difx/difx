...
// $HeadURL: https://svn.atnf.csiro.au/difx/master_tags/DiFX-2.8.1/libraries/mark6sg/mark6sg/mark6_sg_utils.c $
// $LastChangedRevision: 10546 $
// $Author: JanWagner $
// $LastChangedDate: 2022-07-26 16:40:49 +0800 (二, 2022-07-26) $
//
//============================================================================
#include "mark6sg.h"
