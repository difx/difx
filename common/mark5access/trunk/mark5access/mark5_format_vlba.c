...
static int vlba_decode_1bit_1track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_1bit_2track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_1bit_2track_fanout2(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_1bit_4track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_1bit_4track_fanout2(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_1bit_4track_fanout4(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_1bit_8track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_1bit_8track_fanout2(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_1bit_8track_fanout4(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_1bit_16track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1;
...
static int vlba_decode_1bit_16track_fanout2(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1;
...
static int vlba_decode_1bit_16track_fanout4(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1;
...
static int vlba_decode_1bit_32track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
...
static int vlba_decode_1bit_32track_fanout2(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1, *fp2, *fp3;
...
static int vlba_decode_1bit_32track_fanout4(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1, *fp2, *fp3;
...
static int vlba_decode_1bit_64track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
...
static int vlba_decode_1bit_64track_fanout2(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1, *fp2, *fp3, *fp4, *fp5, *fp6, *fp7;
...
static int vlba_decode_1bit_64track_fanout4(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1, *fp2, *fp3, *fp4, *fp5, *fp6, *fp7;
...
static int vlba_decode_2bit_2track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_2bit_4track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_2bit_4track_fanout2(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_2bit_8track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_2bit_8track_fanout2(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_2bit_8track_fanout4(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp;
...
static int vlba_decode_2bit_16track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1;
...
static int vlba_decode_2bit_16track_fanout2(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1;
...
static int vlba_decode_2bit_16track_fanout4(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1;
...
static int vlba_decode_2bit_32track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1, *fp2, *fp3;
...
static int vlba_decode_2bit_32track_fanout2(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1, *fp2, *fp3;
...
static int vlba_decode_2bit_32track_fanout4(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint32_t *buf, bits;
	float *fp0, *fp1, *fp2, *fp3;
...
static int vlba_decode_2bit_64track_fanout1(struct mark5_stream *ms, int nsamp,
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1, *fp2, *fp3, *fp4, *fp5, *fp6, *fp7;
...
static int vlba_decode_2bit_64track_fanout2(struct mark5_stream *ms, int nsamp, 
	float **data)
{
	uint8_t *buf;
	float *fp0, *fp1, *fp2, *fp3, *fp4, *fp5, *fp6, *fp7;
...
static int vlba_decode_2bit_64track_fanout4(struct mark5_stream *ms, int nsamp, 
	float **data)
{
	uint64_t *buf, bits;
	float *fp0, *fp1, *fp2, *fp3, *fp4, *fp5, *fp6, *fp7;
...
static int mark5_format_vlba_make_formatname(struct mark5_stream *ms)
{
	...
	sprintf(ms->formatname, "VLBA1_%d-%d-%d-%d", f->fanout, ms->Mbps, 
		ms->nchan, ms->nbit);
	...
	int nbit, int fanout)
{
	...
	switch(decoderindex)
	{
		case 0 : f->decode = vlba_decode_1bit_1track_fanout1; break;
		case 3 : f->decode = vlba_decode_1bit_2track_fanout1; break;
		case 4 : f->decode = vlba_decode_1bit_2track_fanout2; break;
		case 6 : f->decode = vlba_decode_1bit_4track_fanout1; break;
		case 7 : f->decode = vlba_decode_1bit_4track_fanout2; break;
		case 8 : f->decode = vlba_decode_1bit_4track_fanout4; break;
		case 9 : f->decode = vlba_decode_1bit_8track_fanout1; break;
		case 10: f->decode = vlba_decode_1bit_8track_fanout2; break;
		case 11: f->decode = vlba_decode_1bit_8track_fanout4; break;
		case 12: f->decode = vlba_decode_1bit_16track_fanout1; break;
		case 13: f->decode = vlba_decode_1bit_16track_fanout2; break;
		case 14: f->decode = vlba_decode_1bit_16track_fanout4; break;
		case 15: f->decode = vlba_decode_1bit_32track_fanout1; break;
		case 16: f->decode = vlba_decode_1bit_32track_fanout2; break;
		case 17: f->decode = vlba_decode_1bit_32track_fanout4; break;
		case 18: f->decode = vlba_decode_1bit_64track_fanout1; break;
		case 19: f->decode = vlba_decode_1bit_64track_fanout2; break;
		case 20: f->decode = vlba_decode_1bit_64track_fanout4; break;
		case 24: f->decode = vlba_decode_2bit_2track_fanout1; break;
		case 27: f->decode = vlba_decode_2bit_4track_fanout1; break;
		case 28: f->decode = vlba_decode_2bit_4track_fanout2; break;
		case 30: f->decode = vlba_decode_2bit_8track_fanout1; break;
		case 31: f->decode = vlba_decode_2bit_8track_fanout2; break;
		case 32: f->decode = vlba_decode_2bit_8track_fanout4; break;
		case 33: f->decode = vlba_decode_2bit_16track_fanout1; break;
		case 34: f->decode = vlba_decode_2bit_16track_fanout2; break;
		case 35: f->decode = vlba_decode_2bit_16track_fanout4; break;
		case 36: f->decode = vlba_decode_2bit_32track_fanout1; break;
		case 37: f->decode = vlba_decode_2bit_32track_fanout2; break;
		case 38: f->decode = vlba_decode_2bit_32track_fanout4; break;
		case 39: f->decode = vlba_decode_2bit_64track_fanout1; break;
		case 40: f->decode = vlba_decode_2bit_64track_fanout2; break;
		case 41: f->decode = vlba_decode_2bit_64track_fanout4; break;
		default: f->decode = 0;
	}
