...
At the time of writing, the current stable version of DiFX is DiFX-2.9.1. You can look the DiFX tags for more version.

Then we recommend the user to check out stable version right now. If you want to make a fresh check out of v2.9.1, just type:
...
To update if you had previously cloned the DiFX repository prior to the release of DiFX-2.9.1, update your local repository with git pull and then change to the main branch if necessary:
