...
For more recent versions please see documentation on the DiFX wiki \url{https://github.com/difx/difx/wiki} .
...
See \url{https://github.com/difx/difx/wiki/vex2difx} for more complete information and examples.
