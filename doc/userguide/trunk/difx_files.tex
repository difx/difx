...
\begin{enumerate}
  ...
  \item Number of points in the bandpass
...
Following a header line should be the specified number of data lines, each with three space-separated values:
\begin{enumerate}
...
The correction factor to flatten the bandpass would be the complex-valued inverse of these measurements.
