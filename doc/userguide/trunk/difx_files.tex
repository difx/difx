...
setup	& string	&	& The name of the SETUP section to use, or SKIP if this rule describes scans \\
	&		&	& not to correlate \\
outputBandwidth & float        & MHz & Target bandwidth for auto-determined bands. Enables outputband mode. DiFX~2.7. \\
addOutputBand   & $[$string$]$ &     & Explicit outputband definition. Enables outputband mode. DiFX~2.7. \\
	&		&	& freq\@1810.0/bw\@4.0 \\
\hline
\hline
\end{tabular}
