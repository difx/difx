...
\newcommand{\difxonefive}{{\resizebox{!}{10pt}{\includegraphics{15.pdf}}}}
...
VLBA Sensitivity Upgrade MEMO QQ
...
This manual covers DiFX version 1.5.2 and will be kept up to date with each official update to DiFX.
