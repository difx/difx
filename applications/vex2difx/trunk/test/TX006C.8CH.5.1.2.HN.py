...
loif3a.setIf('D', '6cm', 'L', 7900, 'L', 'NA', 0, '6cm', 7900, 4100, 752.25)
loif3a.setPhaseCal(5)
loif3a.setDBEParams(0, -1, -1, 10, 0)
loif3a.setDBERemember(0, 1)
loif3b = VLBALoIfSetup() 
loif3b.setIf('A', '6cm', 'R', 4100, 'U', 'NA', 0, '6cm', 7900, 4100, 752.25)
...
channelSet3a = [ \
  bbc(0, 752.25, 64, 'U', 2, 0), \  # IF A
  bbc(0, 752.25, 64, 'U', 2, 1), \  # IF A
  bbc(1, 752.25, 64, 'L', 2, 6), \  # IF D
  bbc(1, 752.25, 64, 'L', 2, 7)  \  # IF D
  ]
channelSet3b = [ \
  bbc(0, 816.25, 64, 'U', 2, 2), \  # IF A
  bbc(0, 816.25, 64, 'U', 2, 3), \  # IF A
  bbc(0, 826.25, 64, 'U', 2, 4), \  # IF A
  bbc(1, 816.25, 64, 'L', 2, 5)  \  # IF B
  ]
