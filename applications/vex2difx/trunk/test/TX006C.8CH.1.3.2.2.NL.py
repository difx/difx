...
loif3a.setIf('B', '6cm', 'R', 7900, 'L', 'NA', 0, '6cm', 7900, 4100, 3047.75)
...
channelSet3a = [ \
  ...
  bbc(0, 2983.75, 64, 'L', 2, 3), \  # IF B
  bbc(1, 752.25, 64, 'U', 2, 0)  \  # IF A
  ]
channelSet3b = [ \
  bbc(0, 2983.75, 64, 'U', 2, 4), \  # IF C
  bbc(0, 2983.75, 64, 'U', 2, 5), \  # IF C
