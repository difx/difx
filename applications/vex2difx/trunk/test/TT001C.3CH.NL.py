...
channelSet0 = [ \
  bbc(0, 766.875, 2, 'U', 2, 0), \  # IF A
  bbc(0, 766.625, 2, 'U', 2, 2), \  # IF A
  bbc(1, 766.875, 2, 'U', 2, 1), \  # IF C
  bbc(1, 766.625, 2, 'U', 2, 3)  \  # IF C
  ]
...
channelSet1 = [ \
  bbc(0, 766.875, 2, 'U', 2, 0), \  # IF A
  bbc(0, 765.875, 2, 'U', 2, 1), \  # IF A
  bbc(0, 765.75, 2, 'U', 2, 2)  \  # IF A
  ]
...
channelSet2 = [ \
  bbc(0, 765.875, 4, 'U', 2, 0), \  # IF A
  bbc(0, 765.75, 4, 'U', 2, 2), \  # IF A
  bbc(1, 765.875, 4, 'U', 2, 1), \  # IF C
  bbc(1, 765.75, 4, 'U', 2, 3)  \  # IF C
  ]
...
channelSet3 = [ \
  bbc(0, 763.875, 8, 'U', 2, 0), \  # IF A
  bbc(0, 763.75, 8, 'U', 2, 2), \  # IF A
  bbc(1, 763.875, 8, 'U', 2, 1), \  # IF C
  bbc(1, 763.75, 8, 'U', 2, 3)  \  # IF C
  ]
...
channelSet4 = [ \
  bbc(0, 759.875, 16, 'U', 2, 0), \  # IF A
  bbc(0, 759.75, 16, 'U', 2, 2), \  # IF A
  bbc(1, 759.875, 16, 'U', 2, 1), \  # IF C
  bbc(1, 759.75, 16, 'U', 2, 3)  \  # IF C
  ]
...
channelSet5 = [ \
  bbc(0, 751.875, 32, 'U', 2, 0), \  # IF A
  bbc(0, 751.75, 32, 'U', 2, 2), \  # IF A
  bbc(1, 751.875, 32, 'U', 2, 1), \  # IF C
  bbc(1, 751.75, 32, 'U', 2, 3)  \  # IF C
  ]
...
channelSet6 = [ \
  bbc(0, 735.875, 64, 'U', 2, 0), \  # IF A
  bbc(0, 735.75, 64, 'U', 2, 2), \  # IF A
  bbc(1, 735.875, 64, 'U', 2, 1), \  # IF C
  bbc(1, 735.75, 64, 'U', 2, 3)  \  # IF C
  ]
...
channelSet7 = [ \
  bbc(0, 703.875, 128, 'U', 2, 0), \  # IF A
  bbc(0, 703.75, 128, 'U', 2, 2), \  # IF A
  bbc(1, 703.875, 128, 'U', 2, 1), \  # IF C
  bbc(1, 703.75, 128, 'U', 2, 3)  \  # IF C
  ]
