...
const std::string program("vdisks");
const std::string version("0.1");
const std::string verdate("20130614");
...
void usage(const char *pgm)
{
	...
	std::cout << std::endl;
	std::cout << "A program to write VLBA operations files from a .vex file." << std::endl;
	std::cout << std::endl;
	std::cout << "Output files include:" << std::endl;
	std::cout << "  <project>.if  : Project information for site techs" << std::endl;
	std::cout << "  <project>.ce1 : Summary info for the ce1g display" << std::endl;
	std::cout << "  <project>.tx  : Output line(s) for
