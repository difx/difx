...
################################################################################
# transitional hack to retain compatibility through 2.7...3.13 transition
################################################################################
def old_div(x, y):
    '''
    past.utils old_div() provides the original / behavior which gave
    integer division for integers and ordinary division otherwise.
    '''
    if type(x) == int and type(y) == int: return x // y
    return x / y
