This is a distribution of HOPS (version 3.26), the
...
E.g.
    ...
    ../hops-3.26/configure FLIBS='-lf2c -lgcc

might be needed if f77 is really a wrapper around f2c.

If nothing works, contact gbc@mit.edu, who will be interested
...
you can see some plots quickly flash by with:
    ...
    pushd $HOPS_ROOT/bld-3.26/data/ff_testdata
...
as a sub-shell of bash.  For example:
    ...
    Setup HOPS v3.26 with HOPS_ROOT=/home/gbc/HOPS for i686-3.26
    bash$ tcsh
