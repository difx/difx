This is a distribution of HOPS (version 3.22), the
...
E.g.
    ...
    ../hops-3.22/configure FLIBS='-lf2c -lgcc
...
you can see some plots quickly flash by with:
    ...
    pushd $HOPS_ROOT/bld-3.22/data/ff_testdata
...
as a sub-shell of bash.  For example:
    ...
    Setup HOPS v3.22 with HOPS_ROOT=/home/gbc/HOPS for i686-3.22
    bash$ tcsh
