...
/* Define to 1 if modern splines supported */
#define HAVE_GSL_BSPLINE_CALC 1

/* Define to 1 if legacy splines supported */
#define HAVE_GSL_BSPLINE_EVAL 1

/* Define to 1 if you have the <gsl/gsl_blas.h> header file. */
#define HAVE_GSL_GSL_BLAS_H 1

/* Define to 1 if you have the <gsl/gsl_bspline.h> header file. */
...
/* Define to 1 if you have the <gsl/gsl_min.h> header file. */
#define HAVE_GSL_GSL_MIN_H 1

/* Define to 1 if you have the <gsl/gsl_multifit.h> header file. */
#define HAVE_GSL_GSL_MULTIFIT_H 1

/* Define to 1 if you have the <gsl/gsl_multifit_nlinear.h> header file. */
#define HAVE_GSL_GSL_MULTIFIT_NLINEAR_H 1

/* Define to 1 if you have the <gsl/gsl_multifit_nlin.h> header file. */
#define HAVE_GSL_GSL_MULTIFIT_NLIN_H 1
...
#define HAVE_GSL_GSL_STATISTICS_H 1
...
#define HOPS_REVISION 3.26

/* Haystack SVN rev number */
#define HOPS_SVN_REV 4602
...
#define LT_DLSEARCH_PATH "/lib64:/usr/lib64:/lib:/usr/lib:/usr/lib64/R/lib:/usr/lib64/atlas:/usr/lib64/dyninst:/usr/lib64/llvm19/lib:/usr/lib64/octave/10.2.0:/usr/lib64/pipewire-0.3/jack/:/usr/lib64/tcl"
...
#define PACKAGE_BUGREPORT "gbc@mit.edu"

/* Define to the full name of this package. */
#define PACKAGE_NAME "hops"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "hops 3.26"
...
#define PACKAGE_VERSION "3.26"

/* Python install dir */
#define PYTHON_SITE_PREFIX "${PYTHON_PREFIX}/lib/python3.14/site-packages"
