...
def main():
    ...
    parser.add_argument('-r', '--ref_station_cblock_remote', type=str, dest='network_reference_station_bline_station', help='remote station to use for reference station cblock reading', default='')
    ...
    ffres2pcp_conf.frequency_group = 'X'
    ...
    ffres2pcp_conf.network_reference_station_bline_station = args.network_reference_station_bline_station
