 ...
 */
#define strncpy_warn(d,s,l) {int vv;vv=snprintf((d),(l),"%s",(s));if(vv >= (int)(l)){fprintf(stderr,"Warning: String truncation (%d >= %d) at %s line %d\n", vv, (int)(l), __FILE__, __LINE__);}}
 ...
 */
#define snprintf_warn(d,l,f,...) {int vv;vv=snprintf((d),(l),(f),__VA_ARGS__);if(vv >= (int)(l)){fprintf(stderr,"Warning: String truncation (%d >= %d) at %s line %d\n", vv, (int)(l), __FILE__, __LINE__);}}
