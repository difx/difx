...
#
# This version is appropriate to Cycle7 (b1..b4) (2021 and later).
# It differs only in minor ways from the Cycle5 version (2018 and later).
# The template for this file is in:     $ehtc/Readme-Cycle7.txt
...
# band7
#$ehtc/alma-vex-defs.py -rchan -f335600.0 -sL -w58.0     >> $ers.bare  # b1
#$ehtc/alma-vex-defs.py -rchan -f337541.40625 -sL -w58.0 >> $ers.bare  # b2?
#$ehtc/alma-vex-defs.py -rchan -f347600.0 -sU -w58.0     >> $ers.bare  # b3
#$ehtc/alma-vex-defs.py -rchan -f349600.0 -sU -w58.0     >> $ers.bare  # b4
