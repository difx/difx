...
#define WD_VER_STR  WD_PROD_NAME " v" WD_VERSION_STR \
        " Jungo (c) 1997 - 2011 Build Date: " __DATE__ \
        WD_CPU_SPEC WD_DATA_MODEL WD_FILE_FORMAT

#if !defined(POSIX) && (defined(LINUX) || defined(SOLARIS) || defined(APPLE))
    #define POSIX
#endif

#if !defined(UNIX) && (defined(POSIX) || defined(VXWORKS))
    #define UNIX
#endif
...
#if !defined(POWERPC) && (defined(VXWORKS) || defined(APPLE)) && !defined(x86)
    #define POWERPC
#endif
...
enum
{
    LICENSE_OS_WITH_WIZARD = LICENSE_95 | LICENSE_NT | LICENSE_LINUX | LICENSE_SOLARIS | LICENSE_APPLE,
...
#define IOCTL_WD_CARD_REGISTER            WD_CTL_CODE(0x9c8)
...
#define IOCTL_WD_EVENT_REGISTER           WD_CTL_CODE(0x9c9)
...
#define IOCTL_WD_WATCH_PCI_START          WD_CTL_CODE(0x9d0)
...
#else
    #define WD_DEFAULT_DRIVER_NAME_BASE "windrvr6"
    #define WD_DEFAULT_DRIVER_NAME WD_DRIVER_NAME_PREFIX \
